...
async def omikuji(interaction: discord.Interaction):
    ...
    CA = ["健康","学問","恋愛","金運","地力"]
    I = ["キウイマン", "舞う！！！！馬", "マイバチ（1本）", "たこ焼き", "ミ＝ゴス", "縦連", "オタマトーン", "3ヶ月目のカレー", "パピコ", "お寿司（たまご）", "肩幅うさぎ", "ネギ", "15円玉", "醤油", "Dutedimpianekepusaan-分散的絶望夢-", "判定線抱き枕", "オフロスキー", "栗きんとん", "カニンジャ", "ラーメン", "ぐんぐんグルト", "強奪王ブンドルド", "立つドン", "デカハリル", "作品4", "ツャツャエナガ", "沖ノ鳥島", "ぶち殺すゾウ", "デスおぶし", "おふとん", "藤田ことね［雨上がりのアイリス］", "ぽっぽちゃん", "くるぶし", "ダイナマイトボディエナガ", "歩きエナガ", "ヒトデマン", "メスガキ", "ムキムキエナガ", "プリン", "お寿司（サーモン）", "高速黙りモード移行男", "ドダイにしてみせるお姉さん", "横幅エナガ", "カニカマ", "かたつむり", "ピニャータ", "ショットガン", "ポテト（Lサイズ）", "サメ（600cm）", "ネザライトのクワ", "ゴロリ（2体）", "Apex Predator"]
    ...
    if bob < 10:
        ...
        result.append("**評価: 𝑩𝒊𝒈 𝑩𝒐𝒃 𝑻𝒉𝒆 𝑼𝒏𝒊𝒗𝒆𝒓𝒔𝒆**")
...
async def rrharil(interaction: discord.Interaction):
    if interaction.channel_id not in (1400194814624141392, 1048878265168842792):
        await interaction.response.send_message("このチャンネルでは使用できません。", ephemeral=True)
        return
    fi_ra_row = ["ララ", "リリ", "ルル", "レレ", "ロロ", "デス", "ドカ"]
    fo_ra_row = "ラリルレロ"
    ra_row = "ラリルレロポ"
